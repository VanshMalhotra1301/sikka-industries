...
def list_products():
    """Handles the product master directory display and inserts new stock lines."""
    ...
    products = Product.query.order_by(Product.category.desc(), Product.code.asc()).all()
    return render_template('modules/inventory/stock_status.html', products=products)
